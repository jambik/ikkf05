<?php /* Smarty version Smarty-3.1.15, created on 2013-11-20 12:27:44
         compiled from "..\admin\tpl\gallery_item_form.tpl" */ ?>
<?php /*%%SmartyHeaderCode:18217528c80900981d8-99362158%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'b651cfff27156b3293cce06c5f758a50d5924c23' => 
    array (
      0 => '..\\admin\\tpl\\gallery_item_form.tpl',
      1 => 1384884349,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '18217528c80900981d8-99362158',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_528c809096e341_36544137',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_528c809096e341_36544137')) {function content_528c809096e341_36544137($_smarty_tpl) {?><?php if (!is_callable('smarty_function_get_params')) include 'D:\\OpenServer\\domains\\ikkf05\\includes\\smarty-3.1.15\\plugins\\function.get_params.php';
if (!is_callable('smarty_modifier_date_format')) include 'D:\\OpenServer\\domains\\ikkf05\\includes\\smarty-3.1.15\\plugins\\modifier.date_format.php';
?>	<div id="itemForm">
...
" style="display: block;" class="text-center" target="_blank"><img src="<?php echo $_smarty_tpl->tpl_vars['item']->value['image_path'];?>
...
icon/<?php echo $_smarty_tpl->tpl_vars['im']->value['image_name'];?>
" alt="" />
										<div class="image-caption" onclick="EditImageMoreCaption(this, '<?php echo $_smarty_tpl->tpl_vars['im']->value['image_name'];?>
');" title="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['im']->value['image_caption'], ENT_QUOTES, 'UTF-8', true);?>
"><?php echo $_smarty_tpl->tpl_vars['im']->value['image_caption'];?>
</div>
										<div class="text-center"><a class="btn btn-xs btn-danger" href="#" onclick="DeleteImageMore(this, '<?php echo $_smarty_tpl->tpl_vars['im']->value['image_name'];?>
'); return false;"><span class="glyphicon glyphicon-trash"></span> удалить фото</a></div>
									</div>
								<?php } ?>
							</div>
