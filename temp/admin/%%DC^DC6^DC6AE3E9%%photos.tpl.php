<?php /* Smarty version 2.6.22, created on 2013-08-02 14:15:21
         compiled from photos.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'get_params', 'photos.tpl', 6, false),)), $this); ?>
...
<?php if ($this->_tpl_vars['gallery']): ?><h1 style="background: #eee; padding: 5px;"><?php echo $this->_tpl_vars['gallery']['gallery_name']; ?>
</h1><?php endif; ?>
...
<?php if ($_GET['action'] == 'add' || $this->_tpl_vars['item']): ?>
	<?php $_smarty_tpl_vars = $this->_tpl_vars;
$this->_smarty_include(array('smarty_include_tpl_file' => "photos_item_form.tpl", 'smarty_include_vars' => array()));
$this->_tpl_vars = $_smarty_tpl_vars;
unset($_smarty_tpl_vars);
 ?>
<?php endif; ?>
