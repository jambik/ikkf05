<?php /* Smarty version 2.6.22, created on 2013-08-02 14:08:07
         compiled from gallery_items_table.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'get_params', 'gallery_items_table.tpl', 2, false),array('function', 'cycle', 'gallery_items_table.tpl', 17, false),array('modifier', 'strip_tags', 'gallery_items_table.tpl', 28, false),array('modifier', 'strip', 'gallery_items_table.tpl', 28, false),array('modifier', 'escape', 'gallery_items_table.tpl', 28, false),array('modifier', 'truncate', 'gallery_items_table.tpl', 28, false),array('modifier', 'date_format', 'gallery_items_table.tpl', 30, false),)), $this); ?>
		<?php if ($this->_tpl_vars['items']): ?>
		<form action="<?php echo smarty_function_get_params(array('prefix' => '?'), $this);?>
" method="post" id="form_items">
...
">
					<td class="td-id"><input type="checkbox" name="ids[]" value="<?php echo $this->_tpl_vars['value'][$this->_tpl_vars['itemKey']]; ?>
" /> <?php echo $this->_tpl_vars['value'][$this->_tpl_vars['itemKey']]; ?>
</td>
...
<?php endif; ?></div><?php endif; ?>
						...
						<?php endif; ?>
					<?php endforeach; endif; unset($_from); ?>
					<td><a href="photos.php?gallery=<?php echo $this->_tpl_vars['value'][$this->_tpl_vars['itemKey']]; ?>
">Фотографии >>></td>
