...
class Pages extends Base
{
	...
	public function SetItemDbFields()
	{
		...
		$dbField['type'] = 'text';
		$dbField['hint'] = 'Alias страницы (если оставить поле пустым, то он сгенерируется автоматически)';
		$dbField['empty'] = true;
		$dbField['default'] = '';
		$dbField['edit'] = true;
		$dbField['show'] = true;
		...
		$dbField['name'] = 'Модуль';
		$dbField['field'] = 'page_module';
		$dbField['type'] = 'array';
		$dbField['array'] = '$config["modules"]';
		$dbField['empty'] = true;
		$dbField['default'] = 0;
		$dbField['edit'] = true;
		$dbField['show'] = true;
		...
		$dbField['name'] = 'Показывать';
		$dbField['field'] = 'page_show';
		$dbField['type'] = 'flag';
		$dbField['hint'] = 'Показывать страницу в меню сайта';
		$dbField['edit'] = true;
		$dbField['empty'] = true;
		$dbField['default'] = 1;
		$dbField['show'] = true;
