...
class Admin extends Base
{
	...
	{
		if(empty($_POST["admin_password"]) && isset($_POST[$this->DbKey]) && !empty($_POST[$this->DbKey]))
		{
			unset($this->DbFields[$this->GetFieldIdByName("admin_password")]);
		}
		else
		{
		...
		return parent::AssignPostValues();
	}
